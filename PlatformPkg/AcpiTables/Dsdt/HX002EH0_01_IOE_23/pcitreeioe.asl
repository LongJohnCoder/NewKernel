...
// IOE RC B2D1F0
		Package(){0x0001FFFF, 0, 0, 29 },	
// IOE RC B2D3F0
		Package(){0x0003FFFF, 0, 0, 31 },	
// IOE RC B2D4F0
		Package(){0x0004FFFF, 0, 0, 28 },	
// IOE RC B2D5F0
		Package(){0x0005FFFF, 0, 0, 29 },	
// IOE Virt SW DN Port B2D8F0
		Package(){0x0008FFFF, 0, 0, 28 },	
	})
...
// IOE PCIE2PCI Bridge B10D0F0	below device ISB IRQ Routing Infromation
	Name(ARXB, Package(){
		Package(){0x000DFFFF, 0, 0, 29 },	
		Package(){0x000EFFFF, 0, 0, 30 },	
		Package(){0x000EFFFF, 1, 0, 31 },	
		Package(){0x000EFFFF, 2, 0, 28 },	
		Package(){0x000EFFFF, 3, 0, 29 },	
		Package(){0x0010FFFF, 0, 0, 28 },	
		Package(){0x0010FFFF, 1, 0, 29 },	
		Package(){0x0010FFFF, 2, 0, 30 },	 
		Package(){0x0010FFFF, 3, 0, 31 },	
		Package(){0x000FFFFF, 0, 0, 31 },	 
		Package(){0x0012FFFF, 0, 0, 30 },	
	}) 	
