...
#define EVT_SIGNAL_EXIT_BOOT_SERVICES                 EFI_EVENT_SIGNAL_EXIT_BOOT_SERVICES
#define EVT_TIMER                                     EFI_EVENT_TIMER 
#define EVT_NOTIFY_SIGNAL                             EFI_EVENT_NOTIFY_SIGNAL
#define EVT_SIGNAL_VIRTUAL_ADDRESS_CHANGE             EFI_EVENT_SIGNAL_VIRTUAL_ADDRESS_CHANGE
#define SIGNATURE_32                                  EFI_SIGNATURE_32
#define SIGNATURE_64                                  EFI_SIGNATURE_64
#define MIN                                           EFI_MIN
#define MAX                                           EFI_MAX
//
// Typos in R8.x
