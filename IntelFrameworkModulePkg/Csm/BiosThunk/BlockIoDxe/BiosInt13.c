  ...
  )
{
  ...
  //20170725-Patch for Raid card boot UEFI OS fail
  UINT32                 PciId;
  ...
  Bios            = &Dev->Bios;
  Dev->Int13h     = *(UINT32*)(UINTN)(0x13 * 4);
  ...
  )
{
  ...
  BiosBlockIoDev->CurInt13h = *(UINT32*)(UINTN)(0x13 * 4);
  *(UINT32*)(UINTN)(0x13 * 4) = BiosBlockIoDev->Int13h;
  CarryFlag = BiosBlockIoDev->LegacyBios->Int86 (BiosBlockIoDev->LegacyBios, 0x13, &Regs);
  *(UINT32*)(UINTN)(0x13 * 4) = BiosBlockIoDev->CurInt13h;
