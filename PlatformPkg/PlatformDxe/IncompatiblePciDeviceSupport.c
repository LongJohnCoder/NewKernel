...
// Please keep this IGD info as first position as we will update vendor id 
// in the entry to ignore patch.
//
// (0,1,0) BAR1 1GB align
  DEVICE_INF_TAG,
  PCI_DEVICE_ID(0xFFFF, 0x3A03, MAX_UINT64, MAX_UINT64, MAX_UINT64),
  DEVICE_RES_TAG,
  ...
  0,          // RangeMin
  0x3FFFFFFF,               // RangeMax --> Alignment
  1,                        // Bar index (AddrTranslationOffset)
  0,         // AddrLen


// (A,D,0) BAR0 64 bytes align
  DEVICE_INF_TAG,
  PCI_DEVICE_ID(0x1D17, 0x9180, MAX_UINT64, MAX_UINT64, MAX_UINT64),
  DEVICE_RES_TAG,
