...
extern USB_MOUSE_COMMUNICATION_PROTOCOL   * mps2UsbMouseCommunicationInstance;
   ...
   )
{
  ...
  if(mps2UsbMouseCommunicationInstance == NULL || ((mps2UsbMouseCommunicationInstance->MouseDataStatus & 0x03) == 0x00)){
    return EFI_DEVICE_ERROR;
  }
  ...
  // Decode the packet
  //
  if (mps2UsbMouseCommunicationInstance->MouseDataStatus == 0x01 || mps2UsbMouseCommunicationInstance->MouseDataStatus == 0x83) {
    RButton = mps2UsbMouseCommunicationInstance->CurrentMouseData0[0] & 0x02;
    LButton = mps2UsbMouseCommunicationInstance->CurrentMouseData0[0] & 0x01;
    //
    // Update mouse state
    //
    MouseDev->State.RelativeMovementX += (INT8)mps2UsbMouseCommunicationInstance->CurrentMouseData0[1];
    MouseDev->State.RelativeMovementY += (INT8)mps2UsbMouseCommunicationInstance->CurrentMouseData0[2];
    if (mps2UsbMouseCommunicationInstance->MouseDataStatus == 0x01 ){
      mps2UsbMouseCommunicationInstance->MouseDataStatus = 0x00; 
    } else {
      mps2UsbMouseCommunicationInstance->MouseDataStatus = 0x02;
    }
    ValidData = TRUE;
  } else if ((mps2UsbMouseCommunicationInstance->MouseDataStatus & 0x02) == 0x02) {
    RButton = mps2UsbMouseCommunicationInstance->CurrentMouseData1[0] & 0x02;
    LButton = mps2UsbMouseCommunicationInstance->CurrentMouseData1[0] & 0x01;
    //
    // Update mouse state
    //
    MouseDev->State.RelativeMovementX += (INT8)mps2UsbMouseCommunicationInstance->CurrentMouseData1[1];
    MouseDev->State.RelativeMovementY += (INT8)mps2UsbMouseCommunicationInstance->CurrentMouseData1[2];
    mps2UsbMouseCommunicationInstance->MouseDataStatus &= 0xFD;
    ValidData = TRUE;
  }
  if (ValidData) {
