...
#define PEI_CD_EXPRESS_MAX_FILES_IN_DEVICE    8
...
#define PEI_RECOVERY_FILE_NAME_EXT "FD"
...
typedef struct {
  UINTN           Count;
  EFI_PEI_RECOVERY_BLOCK_IO_PPI   *BlockIo[PEI_CD_EXPRESS_MAX_BLOCK_IO_PPI];
} PEI_CD_EXPRESS_VIRTURAL_BLOCK_IO_RECORD;
