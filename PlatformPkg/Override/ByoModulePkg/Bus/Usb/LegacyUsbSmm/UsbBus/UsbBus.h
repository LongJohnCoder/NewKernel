...
extern UINT16  gBoardChipVendor;
extern UINT16  gBoardChipDevice;

#define ZX_VENDOR_ID              0x1D17
#define VIA_VENDOR_ID             0x1106
#define ZX_Device_ID              0x1003//for chx002 use
...
enum {
    ...
    //
    USB_SET_DEVICE_ADDRESS_STALL   = 2 * USB_BUS_1_MILLISECOND,
