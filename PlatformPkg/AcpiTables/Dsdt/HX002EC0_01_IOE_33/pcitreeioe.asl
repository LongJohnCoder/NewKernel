...
// IOE RC B2D2F0
		Package(){0x0002FFFF, 0, 0, 30 },	//CHX002 is 30; 
// IOE RC B2D3F0
		Package(){0x0003FFFF, 0, 0, 31 },	//CHX002 is 31; 
// IOE RC B2D4F0
		Package(){0x0004FFFF, 0, 0, 28 },	//CHX002 is 28;
// IOE RC B2D5F0
...
// IOE RC B2D2F0 Slot
	...
	Name(ARX4, Package(){
// IOE RC B2D2F0 Slot
		Package(){0x0000FFFF, 0, 0, 30 },	//CHX002 is 30; 
		Package(){0x0000FFFF, 1, 0, 31 },	//CHX002 is 31; 
		Package(){0x0000FFFF, 2, 0, 28 },	//CHX002 is 28; 
		Package(){0x0000FFFF, 3, 0, 29 },	//CHX002 is 29; 
	})
	Name(PRX5, Package(){
// IOE RC B2D3F0 Slot
		Package(){0x0000FFFF, 0, LNKH, 0 },
	...
	Name(ARX5, Package(){
// IOE RC B2D3F0 Slot
		Package(){0x0000FFFF, 0, 0, 31 },	//CHX002 is 31; 
		Package(){0x0000FFFF, 1, 0, 28 },	//CHX002 is 28; 
		Package(){0x0000FFFF, 2, 0, 29 },	//CHX002 is 29; 
		Package(){0x0000FFFF, 3, 0, 30 },	//CHX002 is 30; 
	})
	Name(PRX6, Package(){
// IOE RC B2D4F0 Slot
		Package(){0x0000FFFF, 0, LNKH, 0 },	
...
// IOE RC B2D4F0 Slot
		Package(){0x0000FFFF, 0, 0, 28 },	//CHX002 is 28; 
		Package(){0x0000FFFF, 1, 0, 29 },	//CHX002 is 29; 
		Package(){0x0000FFFF, 2, 0, 30 },	//CHX002 is 30; 
		Package(){0x0000FFFF, 3, 0, 31 },	//CHX002 is 31; 
	})
	Name(PRX7, Package(){
// IOE RC B2D5F0 Slot
		Package(){0x0000FFFF, 0, LNKH, 0 },
