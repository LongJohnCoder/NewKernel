...
#define S3BootScriptSaveIoWrite(Width, Address, Count, Buffer) \
          BootScriptSaveIoWrite(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, Width, Address, Count, Buffer)

#define S3BootScriptSaveIoReadWrite(Width, Address, Data, DataMask) \
          BootScriptSaveIoReadWrite(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, Width, Address, Data, DataMask)

#define S3BootScriptSaveMemWrite(Width, Address, Count, Buffer) \
          BootScriptSaveMemWrite(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, Width, Address, Count, Buffer) 

#define S3BootScriptSavePciCfgWrite(Width, Address, Count, Buffer) \
          BootScriptSavePciCfgWrite(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, Width, Address, Count, Buffer)

#define S3BootScriptSaveMemReadWrite(Width, Address, Data, DataMask) \
          SCRIPT_MEM_READ_WRITE(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, Width, Address, Data, DataMask)

#define S3BootScriptSavePciCfgReadWrite(Width, Address, Data, DataMask) \
          BootScriptSavePciCfgReadWrite(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, Width, Address, Data, DataMask)

#define S3BootScriptSaveSmbusExecute(SmBusAddress, Operation, Length, Buffer) \
          BootScriptSaveSmbusExecute(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, ((SmBusAddress) >> 1)  & 0x7f,\
          ((SmBusAddress) >> 8)  & 0xff, Operation, (BOOLEAN) (((SmBusAddress) & (1 << 22)) != 0), Length, Buffer)

#define S3BootScriptSaveStall(Duration) \
          BootScriptSaveStall(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, Duration)

#define S3BootScriptSaveDispatch(EntryPoint) \
          BootScriptSaveDispatch(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, EntryPoint)

#define S3BootScriptSaveMemPoll(Width, Address, BitMask, BitValue, Duration, LoopTimes) \
          BootScriptMemPoll(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, Width, Address, BitMask, BitValue, Duration, LoopTimes)

#define S3BootScriptSaveInformation(Length, Buffer) \
          BootScriptSaveInformation(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, Length, Buffer)

#define S3BootScriptSaveInformationUnicodeString(String) \
          BootScriptSaveInformationUnicodeString(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, String)

#define S3BootScriptSaveInformationAsciiString(String) \
          BootScriptSaveInformationAsciiString(EFI_ACPI_S3_RESUME_SCRIPT_TABLE, String)
...
#define S3BootScriptSaveDispatch(DispatchEntry)
