...
//
GLOBAL_REMOVE_IF_UNREFERENCED EFI_COMPONENT_NAME_PROTOCOL  gUsbBusComponentName = {
...
//
GLOBAL_REMOVE_IF_UNREFERENCED EFI_COMPONENT_NAME2_PROTOCOL gUsbBusComponentName2 = {
  ...
  )
{
  return LookupUnicodeString2 (
           ...
           DriverName,
           (BOOLEAN)(This == &gUsbBusComponentName)
           );
}
